 ...
 */
final class Version20260518005510 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Extending standard shipping method with information about pickup point';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('ALTER TABLE sylius_shipping_method ADD pickup_point_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE sylius_shipping_method ADD CONSTRAINT FK_5FB0EE11682033F1 FOREIGN KEY (pickup_point_id) REFERENCES app_pickup_point (id) ON DELETE SET NULL');
